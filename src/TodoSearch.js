...
function TodoSearch() {
    return(
            ...
            <form class="form" action="https://www.google.com/search" method="GET" target="_blank">
                <div class="input">
                    <input class="input2" name="q" type="search" aria-label="Buscar" placeholder="Buscar tarea" autofocus/>
                    <input type="hidden" name="as_sitesearch" value="google.com"/>
                </div> 
                <button class="boton" aria-label="Buscar" type="submit">
                    <span class="svg"> 
